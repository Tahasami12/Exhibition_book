...
class MainShellController {
  static final ValueNotifier<int> currentTab =
  ValueNotifier<int>(0);
...
class _MainShellState extends State<MainShell> {
  ...
  void initState() {
    ...
    MainShellController.currentTab
  ...
  void _handleTabChange() {
    ...
    if (_currentIndex !=
        MainShellController.currentTab.value) {
      setState(() {
        _currentIndex =
            MainShellController.currentTab.value;
      });
  ...
  Widget build(BuildContext context) {
    final isAr =
        context.watch<LocaleCubit>().state.isArabic;
...
class _MotionTabBarWrapper extends StatefulWidget {
  ...
  @override
  State<_MotionTabBarWrapper> createState() =>
      _MotionTabBarWrapperState();
}

class _MotionTabBarWrapperState
    extends State<_MotionTabBarWrapper>
  ...
  void initState() {
    ...
    final internalIndex =
    isAr ? 3 - widget.currentIndex : widget.currentIndex;
  ...
  void didUpdateWidget(
      covariant _MotionTabBarWrapper oldWidget,
      ) {
  ...
  Widget build(BuildContext context) {
    ...
    final cartItems =
        context.watch<CartCubit>().state.items;
    List<String> labels = [
      t.navHome,
      t.navCategory,
      t.navCart,
