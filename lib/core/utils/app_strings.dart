...
class AppStrings {
  ...
  String get loginSubtitle    => _t('Sign to your account', 'سجل الدخول إلى حسابك');
  String get email            => _t('Email', 'البريد الإلكتروني');
  String get emailHint        => _t('Your email', 'بريدك الإلكتروني');
  String get emailErrorEmpty  => _t('Please enter your email', 'الرجاء إدخال بريدك الإلكتروني');
  String get emailErrorValid  => _t('Please enter a valid email', 'الرجاء إدخال بريد إلكتروني صحيح');
  String get password         => _t('Password', 'كلمة المرور');
  String get passwordHint     => _t('Your password', 'كلمة المرور الخاصة بك');
  String get passErrorEmpty   => _t('Please enter your password', 'الرجاء إدخال كلمة المرور');
  String get passErrorLength  => _t('Password must be at least 6 characters', 'يجب ألا تقل كلمة المرور عن 6 أحرف');
  ...
  String get googleSignIn     => _t('Sign in with Google', 'تسجيل الدخول باستخدام جوجل');
  String get name             => _t('Name', 'الاسم');
  String get nameHint         => _t('Your name', 'اسمك بالكامل');
  String get nameErrorEmpty   => _t('Please enter your name', 'الرجاء إدخال اسمك');
  String get signUpSubtitle   => _t('Create account and discover new books', 'قم بإنشاء حساب واستكشف كتباً جديدة');
  ...
  String get termsPrefix      => _t('By clicking Register, you agree to our ', 'بالنقر على تسجيل، فإنك توافق على ');
  String get termsSuffix      => _t('Terms, Data Policy.', 'الشروط وسياسة البيانات.');
  ...
  String get logoutConfirm => _t('Are you sure you want to logout?', 'هل أنت متأكد أنك تريد تسجيل الخروج؟');
  ...
  // ─── Offers ────────────────────────────────────────────────────────────────
  String coupons(int count) => _t('You Have $count Coupons to use', 'لديك $count كوبون للاستخدام');
  ...
  String get adminSubtitle   => _t('Manage the app easily from here', 'أدر التطبيق بسهولة من هنا');
  ...
  String get youHaveNoOrders   => _t('You have no orders yet.', 'لا توجد طلبات حتى الآن.');
