    ...
    return BlocBuilder<BooksCubit, BooksState>(
      builder: (context, state) {
        ...
        if (state is BooksLoaded) {
          ...
          final List<BookModel> results = state.books.where((b) {
            final titleMatch = b.titleAr.toLowerCase().contains(q) ||
                b.titleEn.toLowerCase().contains(q);
            final authorMatch = b.authorAr.toLowerCase().contains(q) ||
                b.authorEn.toLowerCase().contains(q);
            final categoryMatch = b.categoryAr.toLowerCase().contains(q) ||
                b.categoryEn.toLowerCase().contains(q);
          ...
          if (isMobile) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                return _buildSearchResultItem(context, results[index], isAr);
              },
            );
          } else {
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFF6C47FF).withAlpha(26),
